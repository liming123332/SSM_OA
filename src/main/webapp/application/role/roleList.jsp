...
<div id="roleInfo">
    ...
    <div class="text-c">
        <div class="row cl ">
            <div class="formControls col-6">
                角色名称: <input type="text" v-model="sysRoleC.roleName" class="input-text" style="width: 250px">
            </div>
            <div class="formControls col-6">
                是否有效：
                <span class="select-box" style="width:150px;">
				<select class="select" v-model="sysRoleC.flag" name="flag" id="flag" size="1">
    ...
    <div  class="pd-20">
        ...
        <table class="table table-border table-bordered table-hover table-bg">
            ...
            <tr class="text-c" v-for="(sysRole,index) in pageInfo.list">
                <td><input type="checkbox" v-bind:value="sysRole.roleId" v-model="check" name=""></td>
                ...
                <td class="f-14"><a title="编辑" href="javascript:;" @click="toUpdate(sysRole.roleId)" <%--onclick="admin_role_edit('组织编辑','admin-role-add.html','1')"--%> style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" @click="deleteSysRole(sysRole.roleId)" <%--onclick="admin_role_del(this,'1')" --%>class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
            </tr>
...
<script type="text/javascript">
    ...
    var pageSize = 3;
    var totalCount = 0;
    var url="sysRole/select";
    var sysRole={
        roleName:null,
        flag:'1'
    }
    pagination(pn,pageSize,sysRole,url);
        ...
        methods:{
                        ...
                        success: function (result) {
                            if (result.msg == "成功") {
                                for (var i = 0; i < vue.pageInfo.list.length; i++) {
                                    if (vue.pageInfo.list[i].roleId == id) {
                                ...
                                layer.msg('该角色不能删除！!', {icon: 1, time: 1000})
                             }
            ...
            batchdel:function () {
               ...
               if(vue.check.length==0) {
                   ...
                   $.ajax({
                       type:"post",
                       url:"sysRole/batchDel?idList="+vue.check,
                       success:function (result) {
                           if (result.msg == "成功") {
                               vue.check.forEach(function (item,index) {
                                   vue.pageInfo.list.forEach(function (sysRole,i) {
                                       if(sysRole.roleId==item){
                                           vue.pageInfo.list.splice(i,1);
                                       }
                                   });
                               });
            ...
            jump:function () {
                ...
                var totalCount = 0;
                var url="sysRole/select";
                pagination(pn,pageSize,vue.sysRoleC,url)
            }
        }
    })
