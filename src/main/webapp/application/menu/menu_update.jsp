...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-menu-update">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <select class="select" name="menuType" id="menuType" size="1">
                    <option <c:if test="${sysMenu.menuType==1}">selected="selected"</c:if> value="1">目录</option>
                    <option <c:if test="${sysMenu.menuType==2}">selected="selected"</c:if> value="2">菜单</option>
                    <option <c:if test="${sysMenu.menuType==3}">selected="selected"</c:if> value="3">操作</option>
                </select>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
				...
				<select class="select" name="isPublish" id="isPublish" size="1">
					<option <c:if test="${!sysMenu.isPublish}">selected="selected"</c:if> value="0">否</option>
					<option <c:if test="${sysMenu.isPublish}">selected="selected"</c:if> value="1">是</option>
				</select>
				</span>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <textarea name="menuDesc" id="menuDesc" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)">${sysMenu.menuDesc}</textarea>
