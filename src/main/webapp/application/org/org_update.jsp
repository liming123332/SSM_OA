...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-org-update">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <input type="text" id="orgParentName" name="orgParentName" value="${sysOrg.orgParentName}" class="input-text" datatype="*" nullmsg="父组织名称不能为空" readonly="readonly">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-5">
				...
				<select class="select" name="flag" id="flag" size="1">
                    <option <c:if test="${sysOrg.flag}">selected="selected" </c:if> value="0">否</option>
					<option <c:if test="${sysOrg.flag}">selected="selected" </c:if> value="1">是</option>
				</select>
				</span>
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-5">
                <textarea name="orgDesc" id="orgDesc" cols="" rows="" class="textarea"  placeholder="说点什么...100个字符以内" dragonfly="true" onKeyUp="textarealength(this,100)">${sysOrg.orgDesc}</textarea>
