...
<div class="pd-20">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-5">
            <input type="password" class="input-text" value="" placeholder="" id="userPassword" name="userPassword" datatype="*2-16" nullmsg="密码不能为空">
        </div>
        <div class="col-4"> </div>
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-5">
            <input type="text" class="input-text" value="" placeholder="" id="phone" name="phone" datatype="m" nullmsg="联系电话不能为空">
        </div>
        <div class="col-4"> </div>
    </div>
    <div class="row cl">
        ...
        <div class="formControls col-5">
            <input type="text" class="input-text" value="" placeholder="" id="email" name="email" datatype="*2-16" nullmsg="email不能为空">
        </div>
        <div class="col-4"> </div>
    </div>
    <div class="row cl">
        ...
        <div class="formControls col-5">
            <input type="text" onClick="WdatePicker()" class="input-text Wdate" value="" placeholder="" id="birthday" name="birthday" datatype="*2-16" nullmsg="birthday不能为空">
        </div>
        <div class="col-4"> </div>
    </div>
    <div class="row cl">
